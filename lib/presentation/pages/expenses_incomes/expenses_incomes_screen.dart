...
import 'package:my_pocket/presentation/common_widgets/snackbar.dart';
...
class _ExpensesIncomesScreenState extends State<ExpensesIncomesScreen> {
  ...
  void initState() {
    ...
    dateController.text =
        '${today.day < 10 ? '0${today.day}' : today.day}/${today.month < 10 ? '0${today.month}' : today.month}/${today.year}';
  }
      ...
      if (_formKeyExpensesIncomes.currentState!.validate()) {
        ...
        try {
          final Transactions userTransaction = Transactions(
            uid: null, // UID will be generated by Firestore
            ...
            whenTransaction: parsedDate,
            createdAt: DateTime.now(),
          );

          transactionCubit.addTransaction(userTransaction);

          // Show a success message
          CustomSnackBar.show(context,
              message: widget.isTypeIncome ? 'Ingreso añadido' : 'Gasto añadido',
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                gapH32,
                const Text('Ingresá el monto:', style: bodyLargeRTS),
                gapH32,
                const Text('Total', style: bodySmallRTS),
                TextFormField(
                  ...
                  child: Row(
                    ...
                    children: List.generate(
                      ...
                      (index) => CategoryButtonSelection(
                        ...
                        onTap: () {
                          setState(() => categorySelected = TransactionCategory.values[index]);
                        },
                      ),
                    ),
                  ),
                ...
                gapH32,
                const Text('Detalles', style: bodyLargeRTS),
                gapH20,
                TextFormField(
